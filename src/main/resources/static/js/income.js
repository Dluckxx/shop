var add = function (type) {
    ...
    xhr.open('POST', '/income/check', true);
    xhr.send(formData);
};
var deleteRecord = function (iid) {
    location.href = "/income/delete?iid=" + iid;
};
var deleteCheck = function (iid) {
    ...
    xhr.open('POST', '/income/deleteCheck', true);
    xhr.send(formData);
};